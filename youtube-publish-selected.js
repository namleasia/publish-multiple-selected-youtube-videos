(() => {
    ...
    function allVideos() {
      let allSelected = [...document.querySelectorAll(".style-scope.ytcp-video-row.row-selected")].map((e) => e.closest("ytcp-video-row"));
      
      return allSelected.map((el) => new VideoRow(el));
